...
<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      ...
      <UiSwitch v-model="config.cal_enable" />
    </div>

    <div v-if="config.cal_enable" class="grid grid-cols-1 gap-6 p-6 bg-gray-50 dark:bg-gray-700/30 rounded-xl border border-gray-100 dark:border-gray-700/50 animate-content-in">
      <!-- Provider Selection -->
      ...
      <div v-if="calProvider === 'custom'" class="space-y-1.5 animate-content-in">
